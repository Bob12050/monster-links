  ...
  function helpHtml(){
    ...
    <main>
      ...
      <section class="card helpCard">
        ...
        <div class="helpFlow">
          ${helpStep("🧭","はじめてガイドを見る","任務掲示板のガイド任務を順番に進めると、基本操作を自然に覚えられます。")}
          ...
          ${helpStep("🧩","パーティ枠を見る","大型モンスターは2枠・3枠を使います。合計枠を見ながら編成します。")}
          ${helpStep("👑","ボスに挑む","通常探索を進めるとボスの気配が高まり、ボスに挑戦できます。")}
          ${helpStep("🧬","配合する","配合リストに登録された親2体を使って、新しい仲間を生み出します。")}
        </div>
      </section>
      ...
      <section class="grid two">
        <div class="card helpCard">
          ...
          <div class="helpList">
            <div><b>1.</b> 任務掲示板の「はじめてガイド」を進める</div>
            <div><b>2.</b> はじまり草原で仲間を増やす</div>
            <div><b>3.</b> 初期装備のちからのリングを付ける</div>
      ...
      <section class="card helpCard">
        ...
        <div class="helpGlossary">
          ...
          <div><b>配合</b><span>配合リストで指定された仲間2体から、新しい仲間を作る育成要素です。</span></div>
          <div><b>パーティ枠</b><span>パーティは合計3枠まで。1枠×3体、2枠+1枠、3枠×1体のように編成します。</span></div>
