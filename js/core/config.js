(() => {
  ...
  Object.assign(P,{SAVE_KEY,SLOT_PREFIX,ACTIVE_SLOT_KEY,SLOT_COUNT,GAME_VERSION,SAVE_SCHEMA_VERSION,DEV_PASSWORD,MAX_PARTY,MAX_LEVEL,PARTY_SLOT_LIMIT,TYPES,TYPE_CHART,PERSONALITIES,RANK});
})();
