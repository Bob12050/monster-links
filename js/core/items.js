(() => {
  ...
  P.ITEMS = {
    ...
    abyss_pearl:{name:"深淵の真珠",icon:"🔵",image:"assets/images/items/abyss_pearl.svg",kind:"accessory",price:0,desc:"深海神殿で見つかる真珠。MP・賢さ・守備が上がる。",stat:{mp:26,def:8,wis:12}},
    leviathan_scale:{name:"海竜の鱗",icon:"🐉",image:"assets/images/items/leviathan_scale.svg",kind:"accessory",price:0,desc:"アビスリヴァイアが落とす鱗。HP・守備・賢さが上がる。",stat:{hp:55,def:14,wis:10}},
    demon_horn:{name:"魔角のチャーム",icon:"🩸",image:"assets/images/items/demon_horn.svg",kind:"accessory",price:0,desc:"魔界門の魔物が持つ角。攻撃と賢さが上がる。",stat:{atk:13,wis:12}},
    chaos_crown:{name:"混沌王冠",icon:"👑",image:"assets/images/items/chaos_crown.svg",kind:"accessory",price:0,desc:"デモンロードが落とす王冠。全能力とHPが上がる。",stat:{hp:70,mp:32,atk:16,def:16,spd:12,wis:16}},
  };
